...
<html lang="en-US">
    <head>
        ...
        <title>Sparklene | Floor/Surface Care Detergents | Industrial Detergents</title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/surface/sparklene.jpg" data-rel="magnific-popup" title="Sparklene">
                                                                    <img width="600" height="600" src="images/surface/sparklene.jpg" alt="Sparklene" title="Sparklene"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Sparklene</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p>
-	A highly concentrated spray cleaner.
<br/>-	Ideal for windows, mirrors and all shiny surfaces.
<br/>-	Brings out crystal clear cleanliness.
<br/>-	Comes with easy application handy trigger caps.


                                                </p>
                                                <h4>Application:</h4>
                                                <p>-	Spray Sparklene onto the surface to be cleaned.
<br/>-	Wipe off with a clean cloth or tissue paper.
