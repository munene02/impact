...
<html lang="en-US">
    <head>
        ...
        <title>Boric Acid | Chemical | Other Products </title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/chemicals/boric-acid.jpg" data-rel="magnific-popup" title="Boric Acid">
                                                                    <img width="600" height="600" src="images/chemicals/boric-acid.jpg" alt="Boric Acid" title="Boric Acid"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Boric Acid</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p>
                                                    -	Boric Acid is a slow acting stomach poison  and desiccant that may be used to control insects
