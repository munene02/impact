...
<html lang="en-US">
    <head>
        ...
        <title>Massage Products | diagnostics Products | IMPACT</title>
                                ...
                                <div class="shop">
                                    <ul class="products" data-columns="4">
                                        ...
                                        <li class="product-category product first">
                                          <a href="farm-liniment.php">
                                              <img src="images/skin/farm-liniment-small.jpg" alt="Farm liniment" width="365" height="385"/>
                                              <h3> Farm Liniment</h3>
                                          </a>
                                        </li>
