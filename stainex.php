...
<html lang="en-US">
    <head>
        ...
        <title>Stainex | Floor/Surface Care Detergents | Industrial Detergents</title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/industrial/stainex.jpg" data-rel="magnific-popup" title="Stainex">
                                                                    <img width="600" height="600" src="images/industrial/stainex.jpg" alt="Stainex" title="Stainex"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Stainex</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p>
-	An effective liquid rust and stain remover.
<br/>-	Ideal for stain removal in urinals, toilet bowls, bathrooms, sinks, floors and swimming pools.
<br/>-	Extra cleaning power coupled with disinfecting action.
                                                ...
                                                <h4>Application:</h4>
                                                <p>
-	Dilute 1 litre of Stainex in 9 litres of water for medium soilage.
<br/>-	For heavy soilage dilute 1 litre in 2 litres of water.
<br/>-	Apply on the industrial to be cleaned, brush until foam appears. Leave on for 5-15 minutes.
<br/>-	Brush again then rinse with clean water.
