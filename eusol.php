...
<html lang="en-US">
    <head>
        ...
        <title>Eusol | Skin Hygiene | Skin Disinfectacts</title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/eusol.jpg" data-rel="magnific-popup" title="Eusol">
                                                                    <img width="600" height="600" src="images/skin/eusol.jpg" alt="Eusol" title="Eusol"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Eusol 0.5%w/v 
</h1>
                                                ...
                                                <p>
- Surgical chlorinated soda solution buffered with boric acid to pH 7.5-9.0
<br/>- Stability 2-3 weeks
                                                ...
                                                <h4>Application: </h4>
                                                <p>
-  Useful antiseptic useful in plastic surgery in specific situations.
<br/>-  Applied by either frequent or continuous irrigation.
<br/>-  Has additional property of dissolving necrosed tissue.
...
<br/>-	Reapply after 5 hours-->
                                            ...
                                            <div class="portfolio-attributes">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 col-sm-6">
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 1ltr                                                                       </span>
                                                    </div>
