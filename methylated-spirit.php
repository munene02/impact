...
<html lang="en-US">
    <head>
        ...
        <title>Methylated Spirit | Skin Hygiene | Skin Disinfectacts</title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/methylated-spirit.jpg" data-rel="magnific-popup" title="Methylated Spirit">
                                                                    <img width="600" height="600" src="images/skin/methylated-spirit.jpg" alt="Methylated Spirit" title="Methylated Spirit"/>
                                                                </a>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/methylated-spirit-2.jpg" data-rel="magnific-popup" title="Methylated Spirit">
                                                                    <img width="600" height="600" src="images/skin/methylated-spirit-2.jpg" alt="Methylated Spirit"/>
                                                                </a>
                                                            </li>
                                                            ...
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="0" title="p11">
                                                                        <img width="200" height="200" src="images/skin/methylated-spirit.jpg" alt="Methylated Spirit" title="Methylated Spirit"/>
                                                                    </a>
                                                                </div>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="1" title="Methylated Spirit">
                                                                        <img width="200" height="200" src="images/skin/methylated-spirit-2.jpg" alt="Methylated Spirit"/>
                                                                    </a>
                                                                </div>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Methylated Spirit</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p>
                                                  -	A general purpose disinfectant effective against gram+ve and
gram-ve bacteria,fungi and some viruses.
