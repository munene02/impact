...
<html lang="en-US">
    <head>
        ...
        <title>Sodium Hypochlorite | Floor/Surface Care Detergents | Industrial Detergents</title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/surface/sodium-hypochlorite.jpg" data-rel="magnific-popup" title="Sodium Hypochlorite">
                                                                    <img width="600" height="600" src="images/surface/sodium-hypochlorite.jpg" alt="Sodium Hypochlorite" title="Sodium Hypochlorite"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Sodium Hypochlorite</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p>- Effective chlorine based liquid for water treatment.
...
<br/>-  Add 10ml per 2100 Litres of water and let stand for 1 hour before drinking.
<br/>-    Additionally add 5 ml weekly to maintain effective chlorine levels.
