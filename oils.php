...
<html lang="en-US">
    <head>
        ...
        <title>Oils | Other Products | IMPACT</title>
        ...
        <link rel='stylesheet' href='css/oils-selector.css' type='text/css' media='all'/>
    ...
    <body data-spy="scroll">
                                ...
                                <div class="shop">
                                    <ul class="products" data-columns="4">
                                        <li class="product-category product first">
                                            <a href="#">
                                                <img src="images/oils/peppermint-oil-small.jpg" alt="Peppermint Oil" width="365" height="385"/>
                                                <h3>Peppermint Oil</h3>
                                            </a>
                                        </li>
                                        <li class="product-category product">
                                            <a href="#">
                                                <img src="images/oils/olive-oil-small.jpg" alt="Olive Oil" width="365" height="385"/>
                                                <h3>Olive Oil</h3>
                                            </a>
                                        </li>
                                        <li class="product-category product">
                                            <a href="#">
                                                <img src="images/oils/lavender-small.jpg" alt="Lavender Oil" width="365" height="385"/>
                                                <h3>Lavender Oil</h3>
                                            </a>
                                        </li>
                                        <li class="product-category product last">
                                            <a href="#">
                                                <img src="images/oils/coconut-oil-small.jpg" alt="Coconut Oil" width="365" height="385"/>
                                                <h3>Coconut Oil</h3>
                                            </a>
                                        </li>
                                    ...
                                    <ul class="products" data-columns="4">
                                        <li class="product-category product first">
                                            <a href="#">
                                                <img src="images/oils/citronella-oil-small.jpg" alt="Citronella Oil" width="365" height="385"/>
                                                <h3>Citronella Oil</h3>
                                            </a>
                                        </li>
                                        <li class="product-category product">
                                            <a href="#">
                                                <img src="images/oils/castor-oil-small.jpg" alt="Castor Oil" width="365" height="385"/>
                                                <h3>Castor Oil</h3>
                                            </a>
                                        </li>
        ...
        <script type='text/javascript' src='js/oils-selector.js'></script>
