...
<html lang="en-US">
    <head>
        ...
        <title>Pure Glycerine | Bases | Other Products</title>
                    ...
                    <div class="heading-wrap">
                        <div class="container">
                            <div class="page-title">
                                <h1>Other Products > Bases > Pure Glycerine  </h1>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/other/glycerine.jpg" data-rel="magnific-popup" title="Pure Glycerine">
                                                                    <img width="600" height="600" src="images/other/glycerine.jpg" alt="Pure Glycerine" title="Pure Glycerine"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Pure Glycerine
</h1>
                                                ...
                                                <p>
An excellent moisturizer that is non-volatile and intensely hygroscopic.<br/>
Can be rinsed off the skin surface with water.


                                                </p>
                                                <h4>Application:</h4>
                                                <p>
                                                  -	A useful solvent in pharmaceutical compounding. Carries most materials mixed with it into the skin.
<br/>-	This pure form kills all bacteria by instantly drawing the water out of them. Eliminates halitosis by killing sulfurous bacteria on back of tongue if swished and gargled.
<br/>- Eliminates skin disturbances from psoriasis to bug bites or burns. Feels oily, vanishes into the skin in about 10 minutes- signals cells to open transport channels.
        ...
        <script type='text/javascript' src='js/other-selector.js'></script>
