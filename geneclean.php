...
<html lang="en-US">
    <head>
        ...
        <title>Geneclean | Floor/Surface Care Detergents | Industrial Detergents</title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/industrial/geneclean.jpg" data-rel="magnific-popup" title="Geneclean">
                                                                    <img width="600" height="600" src="images/industrial/geneclean.jpg" alt="Geneclean" title="Geneclean"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Geneclean</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p>
-	A gentle multi-purpose liquid detergent
<br/>-	Ideal for cleaning and degreasing utensils, floors and hands in hotels, hospitals and institutions.
<br/>-	Fresh lemon fragrance.
                                                ...
                                                <h4>Application:</h4>
                                                <p>
-	For medium soiled surfaces mix 400 ml in 20 litres of water. Apply the solution to the surface, brush and rinse using the two bucket technique.
<br/>-	If Geneclean is diluted in hot water treatment time will be shortened and results improved.
<br/>-	Use undiluted for heavy soilage.
