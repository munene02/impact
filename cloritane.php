...
<html lang="en-US">
    <head>
        ...
        <title>Cloritane | Skin Hygiene | Skin Disinfectacts</title>
                    ...
                    <div class="heading-wrap">
                        <div class="container">
                            <div class="page-title">
                                <h1>Skin Disinfectanct & Surface/Equipment/Inanimate Objects Disinfectanct</h1>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/cloritane.jpg" data-rel="magnific-popup" title="Cloritane">
                                                                    <img width="600" height="600" src="images/skin/cloritane.jpg" alt="Cloritane" title="Cloritane"/>
                                                                </a>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/cloritane-2.jpg" data-rel="magnific-popup" title="Cloritane">
                                                                    <img width="600" height="600" src="images/skin/cloritane-2.jpg" alt="Cloritane"/>
                                                                </a>
                                                            </li>
                                                            ...
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="0" title="p11">
                                                                        <img width="200" height="200" src="images/skin/cloritane.jpg" alt="Cloritane" title="Cloritane"/>
                                                                    </a>
                                                                </div>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="1" title="Cloritane">
                                                                        <img width="200" height="200" src="images/skin/cloritane-2.jpg" alt="Cloritane"/>
                                                                    </a>
                                                                </div>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Cloritane (Chlorhexidine digluconate 5% w/v)</h1>
...
<br>-	Most active in neutral or alkaline conditions
<br>-	A surface active agent is present to inhibit precipitation when dilutions are made with hard water.
<br>-	Dilute to a suitable concentration with freshly distilled water, tap water or alcohol.
<br>-	120ml made upto 3.5L with water
<br>-	This dilution is suitable for swabbing in obstetrics, wounds and burns.
<br>-For storage of sterile instruments, first sterilize the dilution by autoclaving at 115°C-116°C for 30 min. or at 121°C-123°C for 15 min.
<br>-	Dilute 5 ml in 15 ml of water made upto 100ml with 95% alcohol (1 in 10)
<br>-	For preoperative skin disinfection.
<br>-	For disinfection of emergency instruments immerse for 2 minutes excluding endoscopes containing cemented glass compounds.
                                                    ...
                                                    <div class="col-md-12 col-sm-6">
                                                      <h4>Pack Size:</h4>
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 50ml                                                              </span>
                                                    </div>
                                                    <div class="col-md-12 col-sm-6">
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 100ml                                                                       </span>
                                                    </div>
                                                    <div class="col-md-12 col-sm-6">
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 500ml                                                                       </span>
                                                    </div>
                                                    <div class="col-md-12 col-sm-6">

                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 1L
                                                        </span>
                                                    </div>
                                                    <div class="col-md-12 col-sm-6">
                                                        <span class="portfolio-attribute">
