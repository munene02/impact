...
<html lang="en-US">
    <head>
        ...
        <title>Sonella | Floor/Surface Care Detergents | Industrial Detergents</title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/surface/sonella.jpg" data-rel="magnific-popup" title="Sonella">
                                                                    <img width="600" height="600" src="images/surface/sonella.jpg" alt="Sonella" title="Sonella"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Sonella</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p>- An acid based cleaner and disinfectant.


                                                </p>
                                                <h4>Application:</h4>
                                                <p>-The quick germicidal action is achieved by contents of highly efficient disinfectants supported by a surface active agent.
<br/><br/><big>Dosage:</big>
<br/><strong>Light Soil:</strong>
<br/>- Mix 10-22 litres of Sonella in 100 litres of water. 
<br/><strong>Medium Soilage:</strong>
<br/>- Mix 23-36 litres of Sonella to 100 litres of water.
<br/><strong>Heavy Soilage:</strong>
<br/>- Mix 37-50 litres of Sonella to 100 litres of water. Use of water at 40-60°C improves results.. 
<br/>- Apply the diluted solution onto the surface. Allow to act for approx. 10 minutes. Brush and rinse with water.
                                                    ...
                                                    <div class="col-md-12 col-sm-6">
                                                      <h4>Pack Size:</h4>
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 20 ltrs                                                              </span>
                                                    </div>
        ...
        <script type='text/javascript' src='js/surface-selector.js'></script>
