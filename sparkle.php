...
<html lang="en-US">
    <head>
        ...
        <title>Sparkle Universal Cleaner | Floor/Surface Care Detergents | Industrial Detergents</title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/industrial/sparkle.jpg" data-rel="magnific-popup" title="Sparkle Universal Cleaner">
                                                                    <img width="600" height="600" src="images/industrial/sparkle.jpg" alt="Sparkle Universal Cleaner" title="Sparkle Universal Cleaner"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Sparkle Universal Cleaner</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p>
-	An efficient acid based instant degreasing agent.
<br/>-can also be used for disinfection of drinking water
...
<br/>-	Mix 1 litre of Sparkle Universal Stain Remover to 2 litres of water and apply the solution to the areas to be cleaned
