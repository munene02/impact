...
<html lang="en-US">
    <head>
        ...
        <title>Rock Alum | Water Disinfection and Purification | Antiseptics</title>
                    ...
                    <div class="heading-wrap">
                        <div class="container">
                            <div class="page-title">
                                <h1>Antiseptics > Water Disinfection and Purification </h1>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/water/rock-alum.jpg" data-rel="magnific-popup" title="Rock Alum">
                                                                    <img width="600" height="600" src="images/water/rock-alum.jpg" alt="Rock Alum" title="Rock Alum"/>
                                                                </a>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <a href="images/water/rock-alum-2.jpg" data-rel="magnific-popup" title="Rock Alum">
                                                                    <img width="600" height="600" src="images/water/rock-alum-2.jpg" alt="Rock Alum"/>
                                                                </a>
                                                            </li>
                                                            ...
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="0" title="p11">
                                                                        <img width="200" height="200" src="images/water/rock-alum.jpg" alt="Rock Alum" title="Rock Alum"/>
                                                                    </a>
                                                                </div>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="1" title="Rock Alum">
                                                                        <img width="200" height="200" src="images/water/rock-alum-2.jpg" alt="Rock Alum"/>
                                                                    </a>
                                                                </div>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">ROCK ALUM
[Aluminium Sulphate]
</h1>
                                                ...
                                                <p> -Colorless odourless crystals


                                                </p>
                                                <h4>Application:</h4>
                                                <p>
-	A flocculating agent in the purification of drinking water and waste water treatment plants.
<br/>-	Causes impurities to coagulate which are removed as the particulate settles at the bottom of the container or more easily filtered.
<br/>-	Also very effective as a molluscicide killing slugs.
<br/>-	Destroys bacteria, yeast, fungi, spores and viruses.
<br/>-	To make stock solution :( DO NOT DRINK THIS) Add 7gm to 8 litres of water.
<br/>-	To disinfect drinking water: Add 1ml of the stock solution to 100 parts water to be treated. Let the mixture stand for atleast 30 minutes before drinking.
                                                    ...
                                                    <div class="col-md-12 col-sm-6">
                                                      <h4>Pack Size:</h4>
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 50gm                                                             </span>
                                                    </div>
                                                    <div class="col-md-12 col-sm-6">
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i>100gm                                                                       </span>
                                                    </div>
                                                    <div class="col-md-12 col-sm-6">

                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 250gm
                                                        </span>
                                                    </div>
                                                    <div class="col-md-12 col-sm-6">
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 500gm                                                                      </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <script type='text/javascript' src='js/water-selector.js'></script>
