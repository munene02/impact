...
<html lang="en-US">
    <head>
        ...
        <title>Chloritol HC | Skin Hygiene | Skin Disinfectacts</title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/chloritol-hc.jpg" data-rel="magnific-popup" title="Gentian Violet">
                                                                    <img width="600" height="600" src="images/skin/chloritol-hc.jpg" alt="Chloritol HC" title="Chloritol HC"/>
                                                                </a>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/gentian-violet-2.jpg" data-rel="magnific-popup" title="Gentian Violet">
                                                                    <img width="600" height="600" src="images/skin/chloritol-hc-2.jpg" alt="Chloritol HC"/>
                                                                </a>
                                                            </li>
                                                ...
                                                <div class="product-thumbnails-slider single-product-thumbnails" data-visible-max="4" data-visible-min="3" data-responsive="1" data-infinite="1">
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="0" title="Chloritol HC">
                                                                        <img width="200" height="200" src="images/skin/chloritol-hc.jpg" alt="Chloritol HC" title="Chloritol HC"/>
                                                                    </a>
                                                                </div>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="1" title="Chloritol HC">
                                                                        <img width="200" height="200" src="images/skin/chloritol-hc-2.jpg" alt="Chloritol HC"/>
                                                                    </a>
                                                                </div>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Chloritol Hospital Concentrate
[Cetrimide 15%w/v]
[Chlorhexidine digluconate 1.5% w/v]
</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p> -	A clear deep orange-yellow liquid with pine fresh odour.
<br/>-	Ideal as a general purpose antiseptic cleanser.
...
<br/>-	Ideal for disinfection of skin,  equipment and surfaces
<br/>-	Use 10 ml made upto 1 litre with water for   30min immersing of instruments.
<br/>-	40ml made up to 1L with water for treatment of wounds and burns.
<br/>-	Chloritol is incompatible with anionics, soaps and chlorine bleaches.
<br/>-	Hypochlorite bleaches may cause permanent brown stains to develop in fabrics that have previously been in contact with Chloritol. Oxidizing bleach such as sodium perborate should be used in laundering instead.
                                                    ...
                                                    <div class="col-md-12 col-sm-6">
                                                      <h4>Pack Size:</h4>
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 1L                                                              </span>
                                                    </div>
