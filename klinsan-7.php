...
<html lang="en-US">
    <head>
        ...
        <title>Klinsan-7 | Floor/Surface Care Detergents | Industrial Detergents</title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/industrial/klinsan-7.jpg" data-rel="magnific-popup" title="Klinsan-7">
                                                                    <img width="600" height="600" src="images/industrial/klinsan-7.jpg" alt="Klinsan-7" title="Klinsan-7"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Klinsan-7</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p>
- Klinsan 7 contains a concentration of surfactants and disinfection compounds for all washable surfaces including aluminium, silver and melamine. Ideal for cleaning and disinfection of all kitchen surfaces and machinery. Klinsan 7 cleans, disinfects and deodorizes.
                                                ...
                                                <h4>Application:</h4>
                                                <p>
-	Suitable for cleaning of pruning and harvesting machines. Also suitable for removing light rust stains.
<br/>-	An ideal degreasing agent for floors, boiler room  and garage floors.
<br/>-	Mix 1 litre of Klisan 7 to 2 litres of water and apply the solution to the areas to be cleaned
