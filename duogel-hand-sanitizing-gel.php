...
<html lang="en-US">
    <head>
        ...
        <title>Duogel Hand Wash | Skin Disinfectacts</title>
                    ...
                    <div class="heading-wrap">
                        <div class="container">
                            <div class="page-title">
                                <h1>Antiseptics > Skin Disinfectanct > Hand Hygiene</h1>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/duogel-hand-sanitising-gel.jpg" data-rel="magnific-popup" title="Duogel Hand Sanitising Gel">
                                                                    <img width="600" height="600" src="images/skin/duogel-hand-sanitising-gel.jpg" alt="Duogel Hand Sanitising Gel" title="Duogel Hand Sanitising Gel"/>
                                                                </a>
                                                            </li>
                                                        </ul>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Duogel Hand Sanitizing Gel [Isopropanol 70% v/v]</h1>
...
<br/> - Comes with an ideal long nozzle dispenser pump for easy and convenient application.
<br/>	- Contains emollients and lubricants to smoothen application and prevent drying of skin.

                                                </p>
                                                <h4>Application:</h4>
                                                <p>- Effective against bacteria, fungi, viruses, yeast and spores.
<br/>- Ideal for hand sanitizing in medical, food, dental, veterinary and horticultural practice.
<br/>- Apply 1-2 pump squirts of gel onto the palm of one hand and rub both hands together for at least 30 seconds.
<br/>- No need for water, towels or dryers.
<br/>- Ideal for field work, offices, emergency operations and institutions.
<br/>- No progressive bacterial resistance with multiple uses.
</p>
                                                    ...
                                                    <div class="col-md-12 col-sm-6">
                                                      <h4>Pack Size:</h4>
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 65ml
                                                        </span>
                                                    </div>
                                                    <div class="col-md-12 col-sm-6">
                                                        <span class="portfolio-attribute">
