...
<html lang="en-US">
    <head>
        ...
        <title>Oxyclean | Floor/Surface Care Detergents | Industrial Detergents</title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/surface/oxyclean.jpg" data-rel="magnific-popup" title="Oxyclean">
                                                                    <img width="600" height="600" src="images/surface/oxyclean.jpg" alt="Oxyclean" title="Oxyclean"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Oxyclean</h1>
                                                <div class="shop-product-rating">

                                                </div>

<p>- A Liquid Sterilant for the food industry based on Peracetic Acid and Hydrogen Peroxide.
<br/>- Oxyclean is a stable and unique quick acting non foaming sterilizing agent used in the food industry e.g. Breweries, Milk Processing,, Bakeries, Soft Drinks Processing plants, Fish Processing, Canning of Fruits and Vegetables, Candies etc. Oxyclean is effective and quick acting against all types of micro-organisms even in cold water applications. The two ingredients work in synergy the former providing quick sterilization while the hydrogen peroxide makes Oxyclean suitable for flushing, soaking or immersion of food processing equipment.
