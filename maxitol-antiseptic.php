...
<html lang="en-US">
    <head>
        ...
        <title>Maxitol Antiseptic | Skin Hygiene | Skin Disinfectacts</title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/maxitol-antiseptic.jpg" data-rel="magnific-popup" title="Maxitol Antiseptic">
                                                                    <img width="600" height="600" src="images/skin/maxitol-antiseptic.jpg" alt="Maxitol Antiseptic" title="Maxitol Antiseptic"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Maxitol Antiseptic [Cloroxylenol 5% w/v]
</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p> -	A highly effective skin disinfectant with pine fresh fragrance


                                                </p>
                                                <h4>Application:</h4>
                                                <p>
<big>Bathing/Skin Hygiene</big>
<br/>- Add 4 tablespoonfuls to bath water
<br/><br/><big>Spots and Pimples</big>
<br/>- Add 1 tablespoonful to half litre of water. Wash affected area daily.
<br/><br/><big>First Aid (Cuts, Bites, Abrasions, Stings)</big>
<br/>-	Add 1 tablespoonful to half litre of water. Wash affected area and cover with dry gauze or lint.
<br/><br/><big>Cleaning/Disinfecting/General Hygiene</big>
<br/>-	Floor/Surfaces: Add 4 tablespoonfuls to 4L of water.
<br/>-	For Sinks/Toilets/Drains: Use 4 tablespoonfuls undiluted.
                                                    ...
                                                    <div class="col-md-12 col-sm-6">
                                                      <h4>Pack Size:</h4>
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 175ml                                                              </span>
                                                    </div>

                                                    <div class="col-md-12 col-sm-6">
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 250ml                                                                       </span>
                                                    </div>
                                                    <div class="col-md-12 col-sm-6">
                                                        <span class="portfolio-attribute">
