...
<html lang="en-US">
    <head>
        ...
        <title>Water Disinfection and Purification | IMPACT</title>
                        ...
                        <div class="col-md-12 main-wrap">
                            <div class="main-content">
                              <div class="product-slider-title">
                                  <h3 class="el-heading">Water Disinfection and Purification</h3>
                              </div>
                                <div class="empty-space-20"></div>
                                <div class="shop">
                                    <ul class="products" data-columns="4">
                                        <li class="product-category product first">
                                            <a href="rock-alum.php">
                                                <img src="images/water/rock-alum-small.jpg" alt="Rock Alum" width="365" height="385"/>
                                                <h3>Rock Alum</h3>
                                            </a>
                                        </li>
                                        <li class="product-category product">
                                            <a href="duo-bleach.php">
                                                <img src="images/water/duo-bleach-small.jpg" alt="Duo-bleach" width="365" height="385"/>
                                                <h3>Duo-bleach</h3>
                                            </a>
                                        </li>
                                        <li class="product-category product">
                                            <a href="calcium-hypochlorite.php">
                                                <img src="images/water/calcium-hypochlorite-small.jpg" alt="Calcium Hypochlorite" width="365" height="385"/>
                                                <h3>Calcium Hypochlorite</h3>
                                            </a>
                                        </li>
