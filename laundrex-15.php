...
<html lang="en-US">
    <head>
        ...
        <title>Laundrex-15 | Industrial Detergents | Detergents </title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/industrial/laundrex-15.jpg" data-rel="magnific-popup" title="Laundrex-15">
                                                                    <img width="600" height="600" src="images/industrial/laundrex-15.jpg" alt="Laundrex-15" title="Laundrex-15"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Laundrex-15</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p>
                                                    -	A premium quality detergent with excellent stain removal properties.


                                                </p>
                                                <h4>Application:</h4>
                                                <p>-	Suitable for use on all polyethylene-cotton and pure cotton fabrics even coloureds.
<br/>-	Properties: Low foaming, low temperature bleaching ability. Achieves bleaching and disinfection at 40-60°C
<br/>-	Removes oxidizable stains such as coffee, tea, red wine and fruit.
<br/>-	Contains an enzyme for protein stain removal such as blood, fat, milk etc.

<h4>Dosage:</h4>
<big><strong>Single Washing Operation:</strong></big><br/>
8-15gm per kg of laundry.<br/>
<big><strong>Disinfection:</strong></big><br/>
25-35 gm per kg of laundry at 60°C for 15 minutes.
                                                    ...
                                                    <div class="col-md-12 col-sm-6">
                                                      <h4>Pack Size:</h4>
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 5Kg                                                           </span>
                                                    </div>

                                                    <div class="col-md-12 col-sm-6">
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 20Kg                                                                      </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
