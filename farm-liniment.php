...
<html lang="en-US">
    <head>
        ...
        <title>Farm Liniment | Massage Product | Other Products </title>
                    ...
                    <div class="heading-wrap">
                        <div class="container">
                            <div class="page-title">
                                <h1>Other Products > Massage Products </h1>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/farm-liniment.jpg" data-rel="magnific-popup" title="Farm Liniment">
                                                                    <img width="600" height="600" src="images/skin/farm-liniment.jpg" alt="Farm Liniment" title="Farm Liniment"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Farm Liniment</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p>
                                                    -	Contains 12.5% w/v Terebinth Oil
<br/>- A warming rub for muscle pain relief. This effective pain relief formula uses natural evergreen based counter irritants to provide temporary relief from rheumatic pains and aches as well as muscle strains, aches and soreness caused by over exertion.
<br/>- iii.	For external use only. Shake well before use.
