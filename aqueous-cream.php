...
<html lang="en-US">
    <head>
        ...
        <title>Aqueous Cream | Bases | Other Products</title>
                    ...
                    <div class="heading-wrap">
                        <div class="container">
                            <div class="page-title">
                                <h1>Other Products > Bases > Aqueous Cream  </h1>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/other/aqueous-cream.jpg" data-rel="magnific-popup" title="Aqueous Cream">
                                                                    <img width="600" height="600" src="images/other/aqueous-cream.jpg" alt="Aqueous Cream" title="Aqueous Cream"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Aqueous Cream
</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p> -	An innocuous water miscible base.
...
<br> -	Use to soothe, smooth and moisturize sensitive skin.
<br> -	Can be used instead of soap to bathe sensitive skin.
