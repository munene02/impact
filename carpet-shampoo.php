...
<html lang="en-US">
    <head>
        ...
        <title>Carpet Shampoo | Industrial Detergents | Detergents </title>
                    ...
                    <div class="heading-wrap">
                        <div class="container">
                            <div class="page-title">
                                <h1>Detergents > Industrial Detergents > Laundry Detergent</h1>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/industrial/carpet-shampoo.jpg" data-rel="magnific-popup" title="Carpet Shampoo">
                                                                    <img width="600" height="600" src="images/industrial/carpet-shampoo.jpg" alt="Carpet Shampoo" title="Carpet Shampoo"/>
                                                                </a>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <a href="images/industrial/carpet-shampoo-2.jpg" data-rel="magnific-popup" title="Carpet Shampoo">
                                                                    <img width="600" height="600" src="images/industrial/carpet-shampoo-2.jpg" alt="Carpet Shampoo"/>
                                                                </a>
                                                            </li>
                                                            ...
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="0" title="p11">
                                                                        <img width="200" height="200" src="images/industrial/carpet-shampoo.jpg" alt="Carpet Shampoo" title="Carpet Shampoo"/>
                                                                    </a>
                                                                </div>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="1" title="Carpet Shampoo">
                                                                        <img width="200" height="200" src="images/industrial/carpet-shampoo-2.jpg" alt="Carpet Shampoo"/>
                                                                    </a>
                                                                </div>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Carpet Shampoo</h1>
                                                <div class="shop-product-rating">

                                                </div>

- Spray extraction cleaner for carpet floor cleaning.

-	Ideal for deep cleaning and spot removal.
<br/>-	Low in foam with anti-soil effect.
<br/>-	Ideal for interval cleaning as for removal of old shampoo deposits.
<br/>-	Suitable for all types of machines.


</p><h4>Deep Cleaning:</h4>
<p>
Add 400ml-800ml of carpet shampoo to 10 litres of water based on the amount of soilage.

</p><h4>Combined Process:</h4>
<p>
Dilute upto 1:15 with water into the single disc machine. Then carry out the spray extraction.
</p><h4>Removal of spots:</h4>
<p>
Work with a stronger concentration and use the spot removal nozzle.</p>
