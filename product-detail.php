...
<html lang="en-US">
    <head>
        ...
        <title>Surgical Spirit | Skin Hygiene | Skin Disinfectacts</title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/surgical-spirit.jpg" data-rel="magnific-popup" title="Surgical Spirit">
                                                                    <img width="600" height="600" src="images/skin/surgical-spirit.jpg" alt="Surgical Spirit" title="Surgical Spirit"/>
                                                                </a>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/surgical-spirit-2.jpg" data-rel="magnific-popup" title="Surgical Spirit">
                                                                    <img width="600" height="600" src="images/skin/surgical-spirit-2.jpg" alt="Surgical Spirit"/>
                                                                </a>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/surgical-spirit-3.jpg" data-rel="magnific-popup" title="Surgical Spirit">
                                                                    <img width="600" height="600" src="images/skin/surgical-spirit-3.jpg" alt="Surgical Spirit"/>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                            ...
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="0" title="p11">
                                                                        <img width="200" height="200" src="images/skin/surgical-spirit.jpg" alt="Surgical Spirit" title="Surgical Spirit"/>
                                                                    </a>
                                                                </div>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="1" title="Surgical Spirit">
                                                                        <img width="200" height="200" src="images/skin/surgical-spirit-2.jpg" alt="Surgical Spirit"/>
                                                                    </a>
                                                                </div>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="1" title="Surgical Spirit">
                                                                        <img width="200" height="200" src="images/skin/surgical-spirit-3.jpg" alt="Surgical Spirit"/>
                                                                    </a>
                                                                </div>
                                                            </li>
                                                        </ul>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Surgical Spirit</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p>
<br/> -	A general purpose disinfectant that constricts the skin preventing dirt and grime from infecting the skin.
<br/> -		Has anhidritic, astringent and rubacficient properties.


                                                </p>
                                                <h4>Application</h4>
                                                <p>
<br/>- 	Ideal for pre-injection skin disinfection.
<br/>- 	Can be used to harden the skin to prevent bed sores in patients.
