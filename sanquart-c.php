...
<html lang="en-US">
    <head>
        ...
        <title>Sanquart-C | Floor/Surface Care Detergents | Industrial Detergents</title>
                    ...
                    <div class="heading-wrap">
                        <div class="container">
                            <div class="page-title">
                                <h1>Industrial Detergents > Floor/Surface Care Detergents</h1>
                            </div>
                        </div>
                    </div>
                </div>
                                      ...
                                      <div class="col-md-6 col-sm-6">
                                                  ...
                                                  <div class="caroufredsel-wrap">
                                                      <ul class="caroufredsel-items">
                                                          <li class="caroufredsel-item">
                                                              <a href="images/industrial/sanquart-c.jpg" data-rel="magnific-popup" title="Sanquart-C">
                                                                  <img width="600" height="600" src="images/industrial/sanquart-c.jpg" alt="Sanquart-C" title="Sanquart-C"/>
                                                              </a>
                                                          </li>
                                                          <li class="caroufredsel-item">
                                                              <a href="images/industrial/sanquart-c-2.jpg" data-rel="magnific-popup" title="Sanquart-C">
                                                                  <img width="600" height="600" src="images/industrial/sanquart-c-2.jpg" alt="Sanquart-C"/>
                                                              </a>
                                                          </li>
                                                          ...
                                                          <li class="caroufredsel-item">
                                                              <div class="thumb">
                                                                  <a href="#" data-rel="0" title="p11">
                                                                      <img width="200" height="200" src="images/industrial/sanquart-c.jpg" alt="Sanquart-C" title="Sanquart-C"/>
                                                                  </a>
                                                              </div>
                                                          </li>
                                                          <li class="caroufredsel-item">
                                                              <div class="thumb">
                                                                  <a href="#" data-rel="1" title="Sanquart-C">
                                                                      <img width="200" height="200" src="images/industrial/sanquart-c-2.jpg" alt="Sanquart-C"/>
                                                                  </a>
                                                              </div>
                                                          </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Sanquart-C</h1>
...
<br/>-	A food safe sanitizing agent.
...
<br/>-	 Sanquart-C is therefore ideal for use in footbaths and for disinfection of floors, walls, tables, conveyors, wash tanks, graders, truck beds, pallets etc.by spraying or fogging and allowing to drip dry.
<br/>-	Ideal for sanitizing utensils, dishes, splash backs, silverware, trays, table tops, counter tops, floors, walls, sinks and food processing equipment such as coffee makers, freezers, meat blocks, grinders, saws, deep fat fryers, steam kettles and refrigerators
<br/>-	Has the advantage of residual antimicrobial activity.
<br/>-	Can be applied as foam for visual control.
<br/>-	Effective for odour control in drains,
<br/>-	Use undiluted as a surface spray using a mechanical spray device, cloth or mop
<br/>-	For general disinfection use a dilution of 1 litre in 50 litres of
water.
                                                    ...
                                                    <div class="col-md-12 col-sm-6">
                                                      <h4>Pack Size:</h4>
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 5L                                                              </span>
                                                    </div>
                                                    <div class="col-md-12 col-sm-6">
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 20L                                                              </span>
                                                    </div>
        ...
        <script type='text/javascript' src='js/industrial-selector.js'></script>
