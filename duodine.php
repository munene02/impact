...
<html lang="en-US">
    <head>
        ...
        <title>Duodine  | Skin Hygiene | Skin Disinfectacts</title>
                    ...
                    <div class="heading-wrap">
                        <div class="container">
                            <div class="page-title">
                                <h1>Antiseptics > Skin Disinfectanct > Skin Hygiene</h1>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/duodine.jpg" data-rel="magnific-popup" title="Duodine ">
                                                                    <img width="600" height="600" src="images/skin/duodine.jpg" alt="Duodine " title="Duodine "/>
                                                                </a>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/duodine-2.jpg" data-rel="magnific-popup" title="Duodine ">
                                                                    <img width="600" height="600" src="images/skin/duodine-2.jpg" alt="Duodine "/>
                                                                </a>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/duodine-3.jpg" data-rel="magnific-popup" title="Duodine ">
                                                                    <img width="600" height="600" src="images/skin/duodine-3.jpg" alt="Duodine "/>
                                                                </a>
                                                            </li>
                                                            ...
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="0" title="p11">
                                                                        <img width="200" height="200" src="images/skin/duodine.jpg" alt="Duodine " title="Duodine "/>
                                                                    </a>
                                                                </div>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="1" title="Duodine ">
                                                                        <img width="200" height="200" src="images/skin/duodine-2.jpg" alt="Duodine "/>
                                                                    </a>
                                                                </div>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="2" title="Duodine ">
                                                                        <img width="200" height="200" src="images/skin/duodine-3.jpg" alt="Duodine "/>
                                                                    </a>
                                                                </div>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Duodine </h1>
                                                ...
                                                <h4>Application:</h4>
                                                <p>
-	An effective broad spectrum bactericide also effective against yeasts, moulds, fungi, viruses and protozoans.
<br>-	Used for prevention and treatment of skin infections and treatment of wounds.
<br>-	Non irritating, non staining to surrounding tissues
<br>-	Ideal as a surgical scrub for pre and post operative skin cleaning, cleaning and prevention of wounds, ulcers, cuts and burns.
<br>-	Used in gynecology for vaginitis associated with candidal, trichomonal or mixed infections.
                                            ...
                                            <div class="portfolio-attributes">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 col-sm-6">
                                                        ...
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 100ml
                                                        </span>
                                                    </div>
                                                    <div class="col-md-12 col-sm-6">

                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 200ml
                                                        </span>
                                                    </div>
                                                    <div class="col-md-12 col-sm-6">

                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 500ml
                                                        </span>
                                                    </div>
                                                    <div class="col-md-12 col-sm-6">
                                                    ...
                                                    <div class="col-md-12 col-sm-6">
                                                        ...
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 5L
                                                        </span>
                                                    </div>
