...
<html lang="en-US">
    <head>
        ...
        <title>Diagnostics | Diagnostics Products | IMPACT</title>
                                ...
                                <div class="shop">
                                    <ul class="products" data-columns="4">
                                        <li class="product-category product first">
                                            <a href="duogel-ultrasound-gel.php">
                                                <img src="images/diagnostics/duogel-ultrasound-small.jpg" alt="Duogel Ultrasound Gel" width="365" height="385"/>
                                                <h3>Duogel Ultrasound Gel</h3>
                                            </a>
                                        </li>
