...
<html lang="en-US">
    <head>
        ...
        <title>Chemicals | Other Products | IMPACT</title>
        ...
        <link rel='stylesheet' href='css/chemicals-selector.css' type='text/css' media='all'/>
    ...
    <body data-spy="scroll">
                    ...
                    <div class="heading-wrap">
                        <div class="container">
                            <div class="page-title">
                                <h1>Other Products > Chemicals</h1>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="shop">
                                    <ul class="products" data-columns="4">
                                        <li class="product-category product first">
                                            <a href="#">
                                                <img src="images/chemicals/missing-small.jpg" alt="Acetone" width="365" height="385"/>
                                                <h3>Acetone</h3>
                                            </a>
                                        </li>
                                        <li class="product-category product">
                                            <a href="boric-acid.php">
                                                <img src="images/chemicals/boric-acid-small.jpg" alt="Boric Acid" width="365" height="385"/>
                                                <h3>Borid Acid</h3>
                                            </a>
                                        </li>
                                        <li class="product-category product">
                                            <a href="epsom-salt.php">
                                                <img src="images/chemicals/epsom-salt-small.jpg" alt="Epsom Salt" width="365" height="385"/>
                                                <h3>Epsom Salt</h3>
                                            </a>
                                        </li>
                                        <li class="product-category product last">
                                            <a href="cloriscrub.php">
                                                <img src="images/chemicals/cloriscrub-small.jpg" alt="Cloriscrub" width="365" height="385"/>
                                                <h3>Clorisrub</h3>
                                            </a>
                                        </li>
                                    ...
                                    <ul class="products" data-columns="4">
                                        <li class="product-category product first">
                                            <a href="#">
                                                <img src="images/chemicals/missing-small.jpg" alt="Methylsalicylate" width="365" height="385"/>
                                                <h3>Methylsalicylate </h3>
                                            </a>
                                        </li>
                                        <li class="product-category product">
                                            <a href="#">
                                                <img src="images/chemicals/missing-small.jpg" alt="Salicyclic acid" width="365" height="385"/>
                                                <h3>Salicyclic Acid</h3>
                                            </a>
                                        </li>
                                        <li class="product-category product">
                                            <a href="#">
                                                <img src="images/chemicals/missing-small.jpg" alt="Acetic Acid" width="365" height="385"/>
                                                <h3>Acetic Acid</h3>
                                            </a>
                                        </li>
        ...
        <script type='text/javascript' src='js/chemicals-selector.js'></script>
