...
<html lang="en-US">
    <head>
        ...
        <title>Emulsifying Ointment | Bases | Other Products</title>
                    ...
                    <div class="heading-wrap">
                        <div class="container">
                            <div class="page-title">
                                <h1>Other Products > Bases > Emulsifying Ointment  </h1>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/other/emulsifying-ointment.jpg" data-rel="magnific-popup" title="Emulsifying Ointment">
                                                                    <img width="600" height="600" src="images/other/emulsifying-ointment.jpg" alt="Emulsifying Ointment" title="Emulsifying Ointment"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Emulsifying Ointment
</h1>
                                                ...
                                                <h4>Application:</h4>
                                                <p>
                                                  -	Useful as a base for the incorporation of suitable pharmaceutical ingredients.
<br/>-	Provides a protective barrier to damaged skin and creates a conducive environment for wound healing.
<br/>-	Being occlusive it is ideal for the treatment of dry lesions.
                                                    ...
                                                    <div class="col-md-12 col-sm-6">
                                                      <h4>Pack Size</h4>
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 250g                                                             </span>
                                                    </div>

                                                    <div class="col-md-12 col-sm-6">
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 500g                                                                     </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
