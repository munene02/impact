...
<html lang="en-US">
    <head>
        ...
        <title>Chloritol Antiseptic | Skin Hygiene | Skin Disinfectacts</title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/chloritol-antiseptic.jpg" data-rel="magnific-popup" title="Chloritol Antiseptic">
                                                                    <img width="600" height="600" src="images/skin/chloritol-antiseptic.jpg" alt="Chloritol Antiseptic" title="Chloritol Antiseptic"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Chloritol Antiseptic Solution [Cetrimide 3% w/v][Chlorhexidine digluconate 0.3%w/v]
</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p> -	A clear light orange-yellow liquid with pine fresh odour.
...
<br/>-	Use 175 ml made upto 1 litre with water
