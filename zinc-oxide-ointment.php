...
<html lang="en-US">
    <head>
        ...
        <title>Zinc Oxide Ointment | Bases | Other Products</title>
                    ...
                    <div class="heading-wrap">
                        <div class="container">
                            <div class="page-title">
                                <h1>Other Products > Bases > Zinc Oxide Ointment  </h1>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/other/zinc-oxide-ointment.jpg" data-rel="magnific-popup" title="Zinc Oxide Ointment">
                                                                    <img width="600" height="600" src="images/other/zinc-oxide-ointment.jpg" alt="Zinc Oxide Ointment" title="Zinc Oxide Ointment"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Zinc Oxide Ointment
</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p> -	An off white ointment which adheres well to the skin to provide protection.


                                                </p>
                                                <h4>Application:</h4>
                                                <p>
                                                  -	Use as a base to incorporate a variety of chemical ingredients.
<br/>-Useful as a sun block to provide protection from harmful UV and IR rays.
<br/>-As a water proof skin protectant.
