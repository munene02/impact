                                    ...
                                    <div class="row">
                                                ...
                                                <div class="product-thumbnails-slider single-product-thumbnails" data-visible-max="4" data-visible-min="3" data-responsive="1" data-infinite="1">
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="0" title="Surgical Spirit">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Surgical Spirit [Ethanol 95% v/v]</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p> -	A general purpose disinfectant that constricts the skin preventing dirt and grime from infecting the skin.
<br/> -		Has anhidroticastringent and rubacifient properties.
<br/> - Ideal for pre-injection surface disinfection.
...
<br/>- 	Can be used to harden the skin to prevent bed sores on patients.
