...
<html lang="en-US">
    <head>
        ...
        <title>Formalin | Skin Hygiene | Skin Disinfectacts</title>
                    ...
                    <div class="heading-wrap">
                        <div class="container">
                            <div class="page-title">
                                <h1>Antiseptics >Surface/Equipment/Inanimate Objects Disinfectanct</h1>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/surface/formalin.jpg" data-rel="magnific-popup" title="Formalin">
                                                                    <img width="600" height="600" src="images/surface/formalin.jpg" alt="Formalin" title="Formalin"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Formalin [Formaldehyde 37% w/v]
</h1>
                                                ...
                                                <h4>Application:</h4>
                                                <p>
-	Used as a fixative and embalming agent in pathology and as a fixative in histology and microscopy.
<br/>-	An effective disinfectant against bacteria and fungi including spores.
<br/>-	Used as drying agent during wart treatment.
