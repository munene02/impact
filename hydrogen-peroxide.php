...
<html lang="en-US">
    <head>
        ...
        <title>Hydrogen Peroxide | Skin Hygiene | Skin Disinfectacts</title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/hydrogen-peroxide.jpg" data-rel="magnific-popup" title="Hydrogen Peroxide">
                                                                    <img width="600" height="600" src="images/skin/hydrogen-peroxide.jpg" alt="Hydrogen Peroxide" title="Hydrogen Peroxide"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Hydrogen Peroxide 6% w/v
 [20 VOLS]
</h1>
                                                ...
                                                <p> -	An oxygen based disinfectant that acts by oxidizing germs.


                                                </p>
                                                <h4>Application:</h4>
                                                <p>
<br/>- Apply diluted on fresh cuts to stop bleeding and disinfect wounds.
<br/>- Apply diluted solution to cotton wool or lint and cleanse the wound.
<br/>- Also used as a mouthwash and deodorant. Dilute one tablespoonful of Impact Hydrogen Peroxide in a glass of warm water then rinse the mouth 2-3 times 3 times a day.
                                                    ...
                                                    <div class="col-md-12 col-sm-6">
                                                      <h4>Pack Size:</h4>
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 200ml                                                              </span>
                                                    </div>
