...
<html lang="en-US">
    <head>
        ...
        <title>Gentian Violet | Skin Hygiene | Skin Disinfectacts</title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/gentian-violet.jpg" data-rel="magnific-popup" title="Gentian Violet">
                                                                    <img width="600" height="600" src="images/skin/gentian-violet.jpg" alt="Gentian Violet" title="Gentian Violet"/>
                                                                </a>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/gentian-violet-2.jpg" data-rel="magnific-popup" title="Gentian Violet">
                                                                    <img width="600" height="600" src="images/skin/gentian-violet-2.jpg" alt="Gentian Violet"/>
                                                                </a>
                                                            </li>
                                                ...
                                                <div class="product-thumbnails-slider single-product-thumbnails" data-visible-max="4" data-visible-min="3" data-responsive="1" data-infinite="1">
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="0" title="Gentian Violet">
                                                                        <img width="200" height="200" src="images/skin/gentian-violet.jpg" alt="Gentian Violet" title="Gentian Violet"/>
                                                                    </a>
                                                                </div>
                                                            </li>
                                                            <li class="caroufredsel-item">
                                                                <div class="thumb">
                                                                    <a href="#" data-rel="1" title="Gentian Violet">
                                                                        <img width="200" height="200" src="images/skin/gentian-violet-2.jpg" alt="Gentian Violet"/>
                                                                    </a>
                                                                </div>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Gentian Violet [1% w/v ]</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p> -	An anti-infective for local treatment of abrasions, minor cuts, surface injuries and superficial fungus infections of the skin.


                                                </p>
                                                <h4>Application:</h4>
                                                <p>
-	An excellent application for candida albicans. Candida albicans is a fungus that may cause infection of the skin and/or mucus membrane in both children and adults. In children this yeast causes white patches in the mouth (thrush) or diaper rush.
<br/>- Clean the skin and apply directly to the wound or use cotton tipped applicator once or twice daily. Do not bandage.
<br/>-	Medication will stain skin and clothing. For external use only.
