...
<html lang="en-US">
    <head>
        ...
        <title>Mosquitex Mosquito Repellent | Skin Hygiene | Skin Disinfectacts</title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/mosquitex.jpg" data-rel="magnific-popup" title="Mosquitex Mosquito Repellent">
                                                                    <img width="600" height="600" src="images/skin/mosquitex.jpg" alt="Mosquitex Mosquito Repellent" title="Mosquitex Mosquito Repellent"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Mosquitex Mosquito Repellent
</h1>
                                                <div class="shop-product-rating">

                                                </div>

                                                <p> -	An all-round mosquito repellent fitted with a spray pump for ease of application.
                                                  <br/>- Being the season for barbecues, hiking, camping…and mosquitoes? Use Mosquitex Repellent to keep off disease causing mosquitoes  and stop the spread of malaria.


                                                </p>
                                                <h4>How to use: </h4>
                                                <p>
Apply Mosquitex Repellent onto the skin by pressing on the spray pump. Spread to cover all areas of the skin. This product can also be applied on clothes and beddings. Apply every 5 hours for maximum protection.

<!-- -	Spray onto the skin/clothing or into the air
<br/>-	Spread repellent to cover all areas of the skin
<br/>-	Reapply after 5 hours-->
                                                    ...
                                                    <div class="col-md-12 col-sm-6">
                                                      <h4>Pack Size:</h4>
                                                        <span class="portfolio-attribute">
                                                            <i class="fa fa-check-circle"></i> 65ml                                                              </span>
                                                    </div>
