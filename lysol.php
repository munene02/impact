...
<html lang="en-US">
    <head>
        ...
        <title>Lysol | Skin Hygiene | Skin Disinfectacts</title>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/skin/lysol.jpg" data-rel="magnific-popup" title="Lysol">
                                                                    <img width="600" height="600" src="images/skin/lysol.jpg" alt="Lysol" title="Lysol"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Lysol 6% w/v and 12% w/v
</h1>
                                                ...
                                                <p>
- An amber coloured solution with characteristic phenolic odour.
                                                ...
                                                <h4>Application: </h4>
                                                <p>
-  Contains a phenolic biocide and surfactant active against bacteria, some viruses and fungi. 
