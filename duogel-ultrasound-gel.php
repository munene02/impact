...
<html lang="en-US">
    <head>
        ...
        <title>Duogel Ultrasound Gel | Diagnostics | Diagnostics Products</title>
                    ...
                    <div class="heading-wrap">
                        <div class="container">
                            <div class="page-title">
                                <h1>Diagnostics Products > Diagnostics</h1>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="caroufredsel-wrap">
                                                        <ul class="caroufredsel-items">
                                                            <li class="caroufredsel-item">
                                                                <a href="images/diagnostics/duogel-ultrasound.jpg" data-rel="magnific-popup" title="Duogel Ultrasound Gel">
                                                                    <img width="600" height="600" src="images/diagnostics/duogel-ultrasound.jpg" alt="Duogel Ultrasound Gel" title="Duogel Ultrasound Gel"/>
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="summary entry-summary">
                                                <h1 class="product_title entry-title">Duogel Ultrasound Gel
</h1>
                                                ...
                                                <p>
A unique dual viscosity formula that provides superior transmission of ultra sound waves.<br/><br/>
Suitable for diagnostic and treatment therapies.
...
<br/>-	Non irritant
<br/>-	Non fragrant
<br/>-	Applicable within a broad range of frequencies
        ...
        <script type='text/javascript' src='js/diagnostics-selector.js'></script>
